            ...
            <div className="flex flex-col justify-center items-center p-8 md:p-16">
                <div className="w-full max-w-sm space-y-8">
                    ...
                    <div className="pt-2 text-center">
                        <p className="text-xs text-gray-400">Manage your operations</p>
                        ...
                        <p className="text-[10px] text-gray-400 mt-12">© 2026 Wellness Drone Delivery. All rights reserved.</p>
                    </div>
                </div>
            </div>
            <div className="hidden md:flex flex-col justify-center relative p-12 lg:p-20 overflow-hidden bg-[#a44625]">
               <ImageWithFallback 
                   src="/drone-bg.jpg"
                ...
                <div className="relative z-10 text-white max-w-xl">
                    ...
                    <div className="space-y-4">
                        <div className="bg-white/10 backdrop-blur-md border border-white/20 rounded-xl p-5 flex items-center gap-4 hover:bg-white/20 transition cursor-default">
